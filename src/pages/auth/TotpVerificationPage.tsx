...
export default function TotpVerificationPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="absolute top-1/4 right-20 w-24 h-24 border-2 border-blue-200/35 rounded-full animate-float" style={{animationDuration: '6.5s', animationDelay: '0.4s'}}></div>
      <div className="absolute bottom-1/4 left-20 w-32 h-32 border-2 border-purple-200/31 rounded-full animate-float" style={{animationDuration: '7.5s', animationDelay: '1.1s'}}></div>
      <div className="absolute top-1/2 right-1/3 w-20 h-20 border border-indigo-200/27 rounded-full animate-float" style={{animationDuration: '5.5s', animationDelay: '0.6s'}}></div>
      <div className="absolute bottom-1/3 left-1/2 w-28 h-28 border-2 border-pink-200/23 rounded-full animate-float" style={{animationDuration: '8s', animationDelay: '1.7s'}}></div>
      <div className="absolute top-1/6 left-1/3 w-16 h-16 border border-cyan-200/31 rounded-full animate-float" style={{animationDuration: '6s', animationDelay: '0.9s'}}></div>
      <div className="absolute bottom-1/6 right-1/4 w-36 h-36 border-2 border-violet-200/20 rounded-full animate-float" style={{animationDuration: '7s', animationDelay: '1.3s'}}></div>
      <div className="absolute top-2/3 left-1/5 w-22 h-22 border border-blue-200/25 rounded-full animate-float" style={{animationDuration: '5s', animationDelay: '0.5s'}}></div>
      ...
      <div className="absolute top-1/8 right-1/6 w-20 h-20 border border-teal-200/29 rounded-full animate-float" style={{animationDuration: '6s', animationDelay: '1.5s'}}></div>
      <div className="absolute bottom-3/5 left-1/4 w-24 h-24 border-2 border-indigo-200/25 rounded-full animate-float" style={{animationDuration: '8s', animationDelay: '1.2s'}}></div>
      <div className="absolute top-4/5 right-2/5 w-30 h-30 border-2 border-cyan-200/23 rounded-full animate-float" style={{animationDuration: '5.5s', animationDelay: '1.9s'}}></div>
      <div className="absolute bottom-1/5 left-3/5 w-18 h-18 border border-violet-200/29 rounded-full animate-float" style={{animationDuration: '7s', animationDelay: '0.8s'}}></div>
