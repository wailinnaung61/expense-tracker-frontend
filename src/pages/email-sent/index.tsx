...
const PREF_ROWS: {
...
}[] = [
  {
    key: "budgetAlerts",
    icon: Wallet,
    titleKey: "settings.notifications.budgetAlerts",
    hintKey: "settings.notifications.budgetAlertsHint",
  },
  {
    key: "savingGoals",
    icon: Target,
    titleKey: "settings.notifications.savingGoals",
    hintKey: "settings.notifications.savingGoalsHint",
  },
  {
    key: "largeTransactions",
    icon: Calendar,
    titleKey: "settings.notifications.largeTransactions",
    hintKey: "settings.notifications.largeTransactionsHint",
  },
  {
    key: "recurringPayments",
    icon: Bell,
    titleKey: "settings.notifications.recurringPayments",
    hintKey: "settings.notifications.recurringPaymentsHint",
  },
  {
    key: "autoPayments",
    icon: CheckCircle2,
    titleKey: "settings.notifications.autoPayments",
    hintKey: "settings.notifications.autoPaymentsHint",
  },
  {
    key: "paymentFailures",
    icon: AlertTriangle,
    titleKey: "settings.notifications.paymentFailures",
    hintKey: "settings.notifications.paymentFailuresHint",
  },
  {
    key: "exports",
    icon: Receipt,
    titleKey: "settings.notifications.exports",
    hintKey: "settings.notifications.exportsHint",
  },
];
